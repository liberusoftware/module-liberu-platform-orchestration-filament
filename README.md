...
[![Latest release](https://img.shields.io/github/v/release/liberusoftware/module-liberu-platform-orchestration-filament?sort=semver)](https://github.com/liberusoftware/module-liberu-platform-orchestration-filament/releases/latest) [![Tests](https://github.com/liberusoftware/module-liberu-platform-orchestration-filament/actions/workflows/tests.yml/badge.svg?branch=main)](https://github.com/liberusoftware/module-liberu-platform-orchestration-filament/actions/workflows/tests.yml)
...
```bash
composer require liberusoftware/module-liberu-platform-orchestration-filament
```
...
<a href="https://github.com/liberusoftware/module-liberu-platform-orchestration-filament/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=liberusoftware/module-liberu-platform-orchestration-filament" alt="Contributors to liberusoftware/module-liberu-platform-orchestration-filament">
</a>

[View the full contributors graph](https://github.com/liberusoftware/module-liberu-platform-orchestration-filament/graphs/contributors).
